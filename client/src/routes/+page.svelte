<script lang="ts">
    ...
    import { getRoomMetrics, type MetricsPayload } from "$lib/api/ws";
    ...
    onMount(() => {
        ws = getRoomMetrics((payload: MetricsPayload) => {
            ...
            <div class="logo-and-metrics">
                ...
                <div class="metrics">
                    ...
                    <div class="metric">
                        ...
                        <span class="metric-value">{participantCount}</span>
                    </div>
                </div>
            </div>
